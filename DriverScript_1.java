...
import com.sojinfotech.keyworddriven.pageModel.BaseModel;
import com.sojinfotech.keyworddriven.pageModel.DemoPage;
...
public class DriverScript {
    ...
    public static BaseModel actionKeywords;
    ...
    public static String sRunModes;
    ...
    private void execute_TestCase() throws Exception {
        ...
        for (int iTestcase = 1; iTestcase < iTotalTestCases; iTestcase++) {
            ...
            String pageModel =   ExcelUtils.getCellData(iTestcase, Constants.COL_PAGEMODEL, Constants.Sheet_TestCases);
            getPageModelObj(pageModel);
            if (sRunMode.toLowerCase().equals("yes")) {
                ...
                for (; iTestStep < iTestLastStep; iTestStep++) {
                    ...
                    String runModeSteps = ExcelUtils.getCellData(iTestStep, Constants.COL_RUNMODE_STEPS, Constants.Sheet_TestSteps);
                    if (runModeSteps.toLowerCase().equals("no")) {
                        continue;
                    }
    ...
    private void getPageModelObj(String pageModel) {
        if (pageModel.equals("DemoPage")) {
            actionKeywords = new DemoPage();
